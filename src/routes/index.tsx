  ...
  return <div className="min-h-screen bg-background text-foreground">
    ...
    <main>
      <section className="relative flex min-h-[calc(92svh-4rem)] items-end overflow-hidden bg-secondary">
        <img src={infusion.url} alt="Bolsa COCO INFUSION com óleo dourado" className="absolute inset-0 h-full w-full object-contain object-center md:object-cover" />
