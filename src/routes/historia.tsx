        ...
        <header className="border-b border-foreground/15 px-5 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              A gente envazou o verão. Nasceu da paixão, de um sonho de entregar a melhor experiência para os amigos e de transformar o cuidado com a pele em um ritual de autoestima.
            </p>
          </div>
        </header>
