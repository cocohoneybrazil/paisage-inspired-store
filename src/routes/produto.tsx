...
const ritual = ["Esfolie e hidrate a pele previamente para uma aplicação mais uniforme.", "Agite o frasco antes de usar para distribuir a mica e manter o brilho uniforme.", "Faça uma concha com a mão, borrife o óleo nela e espalhe uniformemente para evitar respingos no beachwear.", "Reaplique o óleo após períodos prolongados na água ou de suor intenso."];
