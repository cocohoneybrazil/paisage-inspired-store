...
const ingredients = [["Óleo de buriti", "Rico em betacaroteno e vitaminas A, C e E; ajuda a nutrir e manter a elasticidade da pele."], ["Óleo de urucum", "Fonte de carotenoides e antioxidantes, com ação emoliente e hidratante."], ["Óleo de cenoura", "Ação regeneradora, antioxidante, hidratante e revitalizante."], ["Óleo de coco", "Ácidos naturais que nutrem profundamente e ajudam a preservar a textura da pele."], ["Óleo de amêndoas doce", "Vitaminas e ácidos graxos que ajudam a manter maciez e elasticidade."], ["Óleo de aloe vera", "Hidratação prolongada e cuidado calmante após a exposição ao sol."], ["Mica", "Partículas minerais que conferem luminosidade à pele."], ["Vitamina E", "Antioxidante que complementa o cuidado e a nutrição da fórmula."]];
const ritual = ["Esfolie e hidrate a pele previamente para uma aplicação mais uniforme.", "Proteja a pele com um protetor solar adequado e respeite o tempo de absorção indicado no rótulo.", "Faça uma concha com a mão, borrife o óleo nela e espalhe uniformemente para evitar respingos no beachwear.", "Reaplique o óleo e o protetor solar conforme a orientação de cada produto, especialmente após água ou suor."];
