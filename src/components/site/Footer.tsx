...
export function Footer() {
  return <footer className="border-t border-foreground/15 bg-background">
    <Link to="/produto" className="block overflow-hidden border-b border-foreground/15 bg-background"><img src={wordmark.url} alt="COCO Honey Brazil" loading="lazy" className="h-[36vw] min-h-64 max-h-[580px] w-full object-cover grayscale" /></Link>
